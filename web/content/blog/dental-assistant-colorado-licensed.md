...
image: "blog-xray-rules"
imageAlt: "Dental x-ray images displayed on a clinic monitor"
faq:
  - q: "Is DANB certification required in Colorado?"
    a: "No. DANB certification isn't required to work as a dental assistant in Colorado. Passing DANB's Radiation Health and Safety (RHS) exam, or earning the full CDA, is one of the accepted ways to qualify to take x-rays."
  - q: "Can I work as a dental assistant in Colorado with no training?"
    a: "Yes. Some offices hire and train assistants on the job. You'll still need qualifying radiography training before you take x-rays, and most offices prefer candidates with some formal training."
  - q: "Does Colorado have an expanded functions (EFDA) license?"
